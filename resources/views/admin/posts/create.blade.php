...
<div class="flex justify-between items-center bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 mb-6 mt-16 lg:mt-0">
    <div>
        <h1 class="text-2xl font-bold font-heading text-slate-900 dark:text-white">Viết Bài Mới</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 space-y-6">
                <div>
                    ...
                    <input type="text" name="title" required class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl px-4 py-3 text-lg font-bold focus:ring-2 focus:ring-primary" placeholder="Nhập tiêu đề...">
                </div>

                <div>
                    <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Mô tả ngắn (SEO Excerpt)</label>
                    <textarea name="excerpt" rows="3" class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary" placeholder="Đoạn mô tả ngắn hiển thị trên Google và trang chủ..."></textarea>
                </div>

                <div>
                    <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Nội dung bài viết (HTML)</label>
                    <textarea name="content" rows="15" required class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl px-4 py-3 font-mono text-sm focus:ring-2 focus:ring-primary" placeholder="<p>Nhập nội dung HTML ở đây...</p>"></textarea>
                </div>
            </div>
