...
@section('title', 'Tạo Nhân Viên Mới - PitchManage')
@section('page_title', 'Tạo Tài Khoản Nhân Viên')
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.staffs.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Ví dụ: Nguyễn Văn B" value="{{ old('name') }}" required>
                    </div>

                    <div class="row mb-3">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <label for="email" class="form-label fw-semibold">Địa chỉ Email (Tên đăng nhập)</label>
                            <input type="email" name="email" id="email" class="form-control" placeholder="staffname@gmail.com" value="{{ old('email') }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="phone" class="form-label fw-semibold">Số điện thoại</label>
                            <input type="text" name="phone" id="phone" class="form-control" placeholder="Ví dụ: 0987654321" value="{{ old('phone') }}">
                        </div>
                    </div>
