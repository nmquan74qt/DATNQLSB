...
@section('title', 'Thêm Khung Giờ Mới - PitchManage')
@section('page_title', 'Tạo Khung Giờ')
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.time-slots.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Ví dụ: 17:00 - 18:30" value="{{ old('name') }}" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" name="price_multiplier" id="price_multiplier" class="form-control" placeholder="Ví dụ: 1.50 cho giờ cao điểm" value="{{ old('price_multiplier', '1.00') }}" required>
                        <div class="form-text text-secondary small">1.00 = Không phụ thu giá gốc; 1.50 = Tăng 50% tiền sân trong khung giờ này.</div>
                    </div>
